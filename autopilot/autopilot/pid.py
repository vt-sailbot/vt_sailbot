# everything is pretty much copied from here: https://github.com/m-lundberg/simple-pid/blob/master/simple_pid/pid.py
...
class Rudder_PID(object):
    ...
    def __call__(self, input_, dt=None):
        ...
        # Compute error terms
        error = (self.setpoint - input_) % 360
