...
class GPSPublisher(Node):
    ...
    def __init__(self):
        ...
        self.position_publisher = self.create_publisher(NavSatFix, '/gps_data/position', sensor_qos_profile)
        self.velocity_publisher = self.create_publisher(Vector3, '/gps_data/velocity', sensor_qos_profile)
        # self.heading_publisher = self.create_publisher(Float32, '/gps_data/heading', 2)
